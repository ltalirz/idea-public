...
### Exact parameters
ext = InputSection()
ext.itol = 1e-06                     #: Tolerance of imaginary time propagation (Recommended: 1e-12)
ext.itol_solver = 1e-10              #: Tolerance of linear solver in imaginary time propagation (Recommended: 1e-14)
